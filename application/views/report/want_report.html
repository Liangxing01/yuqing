        ...
        <div id="sidebar" class="nav-collapse">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li class="active"><a href="wantReport.html">Form Components</a></li>
...
//                                echo form_open_multipart('/ReportingMan/report',$att);  ?>
                            <form class="form-horizontal tasi-form" action="/Reporter/report" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control round-input" name="url">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control round-input" name="description">
                                    </div>
                                </div>
